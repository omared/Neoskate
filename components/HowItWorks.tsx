  ...
  return (
    <div className="py-24 container mx-auto px-6">
      <div className="text-center mb-20">
        <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-6">Tu viaje empieza aquí</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
        {steps.map((step, idx) => (
          ...
          >
            <div className="w-20 h-20 bg-zinc-900 rounded-3xl flex items-center justify-center text-emerald-500 mb-8 border border-zinc-800 group-hover:border-emerald-500/50 group-hover:bg-emerald-500 group-hover:text-black transition-all duration-500 shadow-2xl">
